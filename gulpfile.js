...
//   return gulp
//     .src(["./*.html"])
//     .pipe(replace('"./', '"<?php echo get_template_directory_uri()?>/'))
//     .pipe(replace('"/', '"<?php echo get_template_directory_uri()?>/'))
...
// 	var conn = ftp.create({
// 		host: 'nwgtesting.com',
// 		user: 'oetesting@nwgtesting.com',
// 		password: 'HlAnu^9xW%+x',
// 		parallel: 5,
// 		log: gutil.log
// 	});
// 	var globs = [ './**', '!node_modules/**', '!.git/**' ];
// 	return gulp.src(globs, { buffer: false }).pipe(conn.dest('/one500-splash/'));
// });
